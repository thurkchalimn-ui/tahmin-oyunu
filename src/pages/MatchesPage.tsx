...
/**
 * Maçlar sayfası: seçilen günün maçlarını gösterir ve kullanıcının tahmin
 * yapmasını sağlar. Eskiden HomePage'in bir parçasıydı - ana sayfa artık
 * sadece özet (banner, istatistikler, seri, podyum) gösteriyor, buraya
